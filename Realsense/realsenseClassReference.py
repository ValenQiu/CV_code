...
import time
class realsense:
    # 支持机型 415 435 515 (这仨实测过) 其他机型未知估计问题也不大
    ...
    def start(self,resolution='720p',depth_preset=3,fps=30,
              color_scheme=0,histogram_equalization=True,enable_ir_emitter=True):
        '''
        ...
        enable_ir_emitter :bool, optional
            ir发射器, 一般需要开启, 不开的话深度图质量会下降. The default is True.
        Returns
        -------
        None.
        '''
...
if __name__ == '__main__':
    ...
    # 拆解录制的深度图视频
    # h52img(./realsense/depth_map.h5, save_dir='./realsense/depth_map')
