...
# 棋盘格模板规格   Specification of the checkerboard
w = 9   # 10 - 1
h = 6   # 7  - 1
...
imgpoints = [] # 在图像平面的二维点
#加载pic文件夹下所有的jpg图像  load all images in the pic folder
images = glob.glob('./*.jpg')  #   拍摄的十几张棋盘图片所在目录 the direction of the folder

i=0
for fname in images:

    img = cv2.imread(fname)
    # 获取画面中心点 Get the center point of the image
    #获取图像的长宽    Get the length and width of the image
